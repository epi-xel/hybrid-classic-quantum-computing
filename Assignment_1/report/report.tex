...
\item[(3)]
The depth of the circuit is 2, since in the longest path in the circuit there are two
...
We can see that nonethless the entanglement, the outcomes are not equally distributed
as in the previous case. This is due to the noise introduced by the simulator.
